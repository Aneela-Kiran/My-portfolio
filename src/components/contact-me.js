    ...
    <React.Fragment>
      <section id="contact" className=" py-12 mt-16 mx-auto m-4 px-8">
        <div className="container mx-auto px-6 m-5">
          ...
          >
            {/* Contact Form  */}
            <div className="custom-black shadow-3xl w-full md:w-auto  rounded-xl p-10">
                ...
                <div className="flex space-x-4">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className="mt-1 block w-full text-white about-background focus:about-background py-2 px-3 rounded-md shadow-xl focus:border-yellow-500 focus:ring focus:ring-yellow-500 focus:ring-opacity-50 sm:text-sm"
                    />
                  </div>
                  <div className="flex-1">
                ...
                <div className="flex space-x-4">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      value={formData.name}
                      onChange={handleChange}
                      className="mt-1 block w-full text-white about-background focus:about-background py-2 px-3 bg-white-500 rounded-md shadow-xl focus:border-yellow-500 focus:ring focus:ring-yellow-500 focus:ring-opacity-50 sm:text-sm"
                    />
                  </div>
                  <div className="flex-1">
                    <label htmlFor="phone" className="block text-sm text-white">

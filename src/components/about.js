...
const About = () => {
  ...
  return (
   <>
    <section data-aos="fade-up" id='about' className=' about-background shadow-sm py-12 mt-12 mx-auto m-4 px-8'>
    ...
    <h1 className='font-bold text-2xl md:text-3xl text-white mb-8 text-center'>ABOUT <span className='text-yellow-500'>ME</span></h1>
      ...
      {/* about image */}
        ...
        <div data-aos="fade-up"  data-aos-delay="300" data-aos-duration="1000" className='md:w-1/2 items-center mx-auto md:mx-0 py-4 px-4 md:px-0 overflow-hidden'>
